...
class FillPermissionsForCampaignAttribute extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCampaignAttribute constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.campaign-attribute',
            'admin.campaign-attribute.index',
            'admin.campaign-attribute.create',
            'admin.campaign-attribute.show',
            'admin.campaign-attribute.edit',
            'admin.campaign-attribute.delete',
            'admin.campaign-attribute.bulk-delete',
        ]);
