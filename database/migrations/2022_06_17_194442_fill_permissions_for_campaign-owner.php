...
class FillPermissionsForCampaignOwner extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCampaignOwner constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.campaign-owner.index',
            'admin.campaign-owner.create',
            'admin.campaign-owner.show',
            'admin.campaign-owner.edit',
            'admin.campaign-owner.delete',
            'admin.campaign-owner.bulk-delete',
        ]);
