...
class FillPermissionsForDepartament extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForDepartament constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.departament',
            'admin.departament.index',
            'admin.departament.create',
            'admin.departament.show',
            'admin.departament.edit',
            'admin.departament.delete',
            'admin.departament.bulk-delete',
        ]);
