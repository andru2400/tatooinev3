...
class FillPermissionsForOwnerLocation extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForOwnerLocation constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.owner-location',
            'admin.owner-location.index',
            'admin.owner-location.create',
            'admin.owner-location.show',
            'admin.owner-location.edit',
            'admin.owner-location.delete',
            'admin.owner-location.bulk-delete',
        ]);
