...
class FillPermissionsForUserAttributeOption extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForUserAttributeOption constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.user-attribute-option',
            'admin.user-attribute-option.index',
            'admin.user-attribute-option.create',
            'admin.user-attribute-option.show',
            'admin.user-attribute-option.edit',
            'admin.user-attribute-option.delete',
            'admin.user-attribute-option.bulk-delete',
        ]);
