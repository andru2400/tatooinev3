...
class FillPermissionsForCampaignAttributeOption extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCampaignAttributeOption constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.campaign-attribute-option',
            'admin.campaign-attribute-option.index',
            'admin.campaign-attribute-option.create',
            'admin.campaign-attribute-option.show',
            'admin.campaign-attribute-option.edit',
            'admin.campaign-attribute-option.delete',
            'admin.campaign-attribute-option.bulk-delete',
        ]);
