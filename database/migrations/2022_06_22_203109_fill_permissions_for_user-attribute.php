...
class FillPermissionsForUserAttribute extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForUserAttribute constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.user-attribute',
            'admin.user-attribute.index',
            'admin.user-attribute.create',
            'admin.user-attribute.show',
            'admin.user-attribute.edit',
            'admin.user-attribute.delete',
            'admin.user-attribute.bulk-delete',
        ]);
