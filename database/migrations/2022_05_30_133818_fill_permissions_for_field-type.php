...
class FillPermissionsForFieldType extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForFieldType constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.field-type',
            'admin.field-type.index',
            'admin.field-type.create',
            'admin.field-type.show',
            'admin.field-type.edit',
            'admin.field-type.delete',
            'admin.field-type.bulk-delete',
        ]);
